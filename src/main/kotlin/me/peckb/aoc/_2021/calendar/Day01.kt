...
class Day01 @Inject constructor(private val inputGenerator: InputGenerator<Int>) {
   ...
   * noise in the data. Instead, consider sums of a three-measurement sliding window. Again
