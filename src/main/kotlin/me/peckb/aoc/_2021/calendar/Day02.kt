...
import me.peckb.aoc._2021.calendar.Day02.Path.Direction.FORWARD
import me.peckb.aoc._2021.calendar.Day02.Path.Direction.DOWN
import me.peckb.aoc._2021.calendar.Day02.Path.Direction.UP
...
class Day02 @Inject constructor(private val generatorFactory: InputGenerator.InputGeneratorFactory) {
   ...
   * aim, which also starts at 0. The commands also mean something entirely different than you
   * first thought:
   *
