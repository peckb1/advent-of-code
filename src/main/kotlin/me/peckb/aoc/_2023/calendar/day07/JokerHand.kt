...
import me.peckb.aoc._2023.calendar.day07.JokerCard.JOKER

data class JokerHand(val cards: List<JokerCard>, val bid: Int) {
  val jokers = cards.count { it == JOKER }

  val strength: HandStrength by lazy {
    val cardGroups = cards.filterNot { it == JOKER }.groupBy { it.rank }
