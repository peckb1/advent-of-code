...
internal class Day06Test {
  ...
  fun testDay06PartOne() {
    assertEquals("agmwzecr", day06.partOne(DAY_06))
  }

  @Test
  fun testDay06PartTwo() {
    assertEquals("owlaxqvq", day06.partTwo(DAY_06))
  }

  companion object {
    private const val DAY_06: String = "advent-of-code-input/2016/day06.input"
  }
}
