...
internal class Day17Test {
  ...
  fun testDay17PartOne() {
    assertEquals("DUDRDLRRRD", day17.partOne(DAY_17))
  }

  @Test
  fun testDay17PartTwo() {
    assertEquals(502, day17.partTwo(DAY_17))
  }

  companion object {
    private const val DAY_17: String = "advent-of-code-input/2016/day17.input"
  }
}
